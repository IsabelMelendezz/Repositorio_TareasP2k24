...
int main()
{
    ...
    Jugador gamer(configuracionJuego.getvidasTablero());
    ...
    do
    {
        ...
        case 3:
                juego.dibujarscores("scores.txt");
                break;

        case 4: repetir = false;
                juego.dibujarcreditos("creditos.txt");
